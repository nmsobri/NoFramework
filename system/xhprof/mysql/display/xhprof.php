...
function print_flat_data( $url_params, $title, $flat_data, $sort, $run1, $run2, $limit ) {
    ...
    include( "../xhprof/templates/profChart.phtml" );
    include( "../xhprof/templates/profTable.phtml" );
...
function full_report( $url_params, $symbol_tab, $sort, $run1, $run2, $links ) {
    ...
    if ( $diff_mode ) {
        ...
        include "../xhprof/templates/diff_run_header_block.phtml";

    } else {
        global $xhprof_runs_impl;
        include "../xhprof/templates/single_run_header_block.phtml";
    }
